...
MIKE_ALLOW_SERVER_PROVIDER_KEY_FALLBACK=false
...
Local env checklist
  backend/.env:
    ...
    saved in /account/models. Local env provider keys are ignored unless you
    explicitly set MIKE_ALLOW_SERVER_PROVIDER_KEY_FALLBACK=true.
